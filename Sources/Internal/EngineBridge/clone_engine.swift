...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_clone_engine_checksum_method_desktopengine_get_commands() != 48503) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_clone_engine_checksum_constructor_desktopengine_new() != 52589) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_clone_engine_checksum_method_desktopdelegate_on_frame() != 54261) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_clone_engine_checksum_method_desktopdelegate_on_composite_frame() != 55417) {
        return InitializationResult.apiChecksumMismatch
    }
