...
enum StubGenerator {
    ...
    extension Publisher {
        ...
        public func receive(on scheduler: DispatchQueue) -> AnyPublisher<Output, Failure> {
            AnyPublisher<Output, Failure>()
        }
        ...
        public func debounce(for interval: TimeInterval, scheduler: DispatchQueue) -> AnyPublisher<Output, Failure> {
            AnyPublisher<Output, Failure>()
        }
    ...
    public class AVPlayer: NSObject {
        ...
        public init(playerItem item: AVPlayerItem?) { self.currentItem = item; super.init() }
    ...
    public class AVPlayerItem: NSObject {
        ...
        public init(url: URL) { self.asset = AVAsset(url: url); super.init() }
        public init(asset: AVAsset) { self.asset = asset; super.init() }
    }
    ...
    // Import SwiftUI View for Chart conformance
